...
%
%   [NAME,CATEGORY_ID,CHANNEL_ID,USE] = IMPORTFILE1(FILENAME, STARTROW,
%   ENDROW) Reads data from rows STARTROW through ENDROW of text file
%   FILENAME.
%
% Example:
%   [name,category_id,channel_id,use] = importfile1('feature_select_NBT_bigscreen.txt',2, 313);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/05/18 15:57:46
...
category_id = cell2mat(rawNumericColumns(:, 1));
channel_id = cell2mat(rawNumericColumns(:, 2));
use = cell2mat(rawNumericColumns(:, 3));
use = use==1;
